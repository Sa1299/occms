...
{               ?>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-keyboard me-2"></i>Course</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="add-course.php" class="dropdown-item">Add Course</a>
                            <a href="manage-course.php" class="dropdown-item">Manage Course</a>
                        </div>
                    </div>
